...
set(BEATQUAY_NAME "BeatSprig")
set(BEATQUAY_VERSION "1.0.1")
...
set(BEATQUAY_EXECUTABLE_NAME "beatsprig")
set(BEATQUAY_PUBLISHER "Trieflow LLC")
set(BEATQUAY_URL "https://beatsprig.trieflow.com")
...
# Rebuild both the customer host and native test host against the same Windows DLL import name.
function(beatquay_apply_host_identity target)
    if(LMMS_BUILD_WIN32)
        set_target_properties(${target} PROPERTIES OUTPUT_NAME "${BEATQUAY_EXECUTABLE_NAME}")
    endif()
endfunction()
